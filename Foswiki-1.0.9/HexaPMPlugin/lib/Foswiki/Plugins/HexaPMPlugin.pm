...
---+ package HexaPMPlugin


=cut

# change the package name!!!
package Foswiki::Plugins::HexaPMPlugin;
...
our $RELEASE = '$Date: 20010-09-03 09:52:40 +0100 (Fri, 03 Sep 2010) $';

# Short description of this plugin
# One line description, is shown in the %SYSTEMWEB%.TextFormattingRules topic:
our $SHORTDESCRIPTION = 'This plugin has all the utilities for manage projects';
...
sub restCreateProject {
	...
	Foswiki::Func::writeWarning($name); 
	return Foswiki::Plugins::HexaPMPlugin::Core::createProject($name, $description, $startDate, $projectManager, $session);
}
